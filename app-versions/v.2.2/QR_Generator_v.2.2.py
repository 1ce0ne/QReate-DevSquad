    ...
    while current_number <= end_number:
        ...
        for row in range(QR_ROWS):
            for col in range(QR_COLUMNS):
                ...
                img.save(img_path)
                c.drawImage(img_path, x + (BACKGROUND_WIDTH - QR_SIZE) / 2, y + (BACKGROUND_HEIGHT - QR_SIZE + 4.3) / COORD_QR,
...
def update_qr_parameters():
    global QR_SIZE, PADDING, BACKGROUND_WIDTH, BACKGROUND_HEIGHT, COORD_QR, COORD_NUM, QR_COLUMNS, QR_ROWS, FONT_SIZE, DOP_QR
