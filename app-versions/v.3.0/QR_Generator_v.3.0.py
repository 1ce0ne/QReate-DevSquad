...
QRCodeGenerator.geometry("430x800")
...
RangeToQrToLabel = CTkLabel(master=RangeOfQR,
                            ...
                            font=("Arial", 14),
                            text='До:')
RangeToQrToLabel.place(x=220, y=36)
...
SliderColumnValueLabel = ctk.CTkLabel(ColumnQrOnList,
                                      ...
                                      text_color="white",
                                      font=("Arial", 16))
SliderColumnValueLabel.place(x=125, y=5)
...
SliderRowsValueLabel = ctk.CTkLabel(RowsQrOnList,
                                    ...
                                    text_color="white",
                                    font=("Arial", 16))
SliderRowsValueLabel.place(x=125, y=5)
...
SaveDirectoryLabel = CTkLabel(SaveDirectory,
                              ...
                              text_color="white",
                              font=("Arial", 16))
SaveDirectoryLabel.place(x=35, y=5)
